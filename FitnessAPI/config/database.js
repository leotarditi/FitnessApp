    ...
    if(err) {
        ...
        (err) => {
            if (err) {
                ...
                var insert = 'INSERT INTO exercise (title, description, img, leftColor, rightColor)\
                                VALUES (?,?,?,?,?)'
                db.run(insert, ["Technique Guides",
                                "Learn amazing street workout and calisthenics",
                                ...
                                "#A74CF2",
                                "#617BFB"])
                db.run(insert, ["Skills Training",
                                "Learn the secrets of bodyweight techniques",
                                ...
                                "#17EAD9",
                                "#6078EA"])
                db.run(insert, ["Strength Training",
                                "Train anytime, everywere and become a superhero!",
